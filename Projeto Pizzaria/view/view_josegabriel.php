<?php
	...
	$daoJoseGabriel = new DAOJoseGabriel();
	$listaJoseGabriel = $daoJoseGabriel->listarJoseGabriel();
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="view_josegabriel.php">Jose Gabriel</a></li>
...
<div class="container">
	...
	<form action="../controller/incluir_exemplobase.php" method="post">
		<fieldset>
  			...
  			<table class="table table-hover">
  				...
  				?>	
    				<tr>
    					...
    					<td class="col-md-1">
    						<a class="btn btn-danger" href="../controller/excluir_exemplobase.php?codigo=<?= $objetoNomeSobreNome->getCodigo(); ?>" role="button">Excluir</a>  								
    					</td>
    				</tr>
    			<?php
					}
